...
public partial class UserProfilePage : ContentPage
{
    ...
    private async void OnEditProfile(object sender, EventArgs e) => await Navigation.PushAsync(new EditProfilePage(_currentUser));

    private async void OnOrderHistory(object sender, EventArgs e) => await Navigation.PushAsync(new OrderHistoryPage(_currentUser));
